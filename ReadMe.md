...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMatch hook is used to add nested routes routes to your app. For example, you can change the parameter in the url without needing to change the whole thing.
2. How would you explain form validation to someone who has never programmed before?
    I would explain to someone that validation is making sure that the form works, therefore you can add in whatever you type, delete, and if you leave it empty, an error will pop up.
3. In 1-2 sentences, define end to end testing. 
    End to end testing is a great resource that you can use cypress for. It acts like a user and is able to test all the funcitonality of your app without you or someone else needing to take the time and catch errors yourself
